export type DisputeReason = 'POOR_QUALITY' | 'OVERCHARGING' | 'NO_SHOW' | 'UNPROFESSIONAL_BEHAVIOUR' | 'DAMAGE_OR_LOSS' | 'OTHER';
export type DisputeStatus = 'OPEN' | 'UNDER_REVIEW' | 'RESOLVED' | 'DISMISSED';
export type SafetySeverity = 'LOW' | 'MEDIUM' | 'HIGH' | 'CRITICAL';
export type SafetyCategory = 'HARASSMENT' | 'THEFT' | 'VIOLENCE' | 'PROPERTY_DAMAGE' | 'UNSAFE_ENVIRONMENT';
export type SafetyIncidentStatus = 'REPORTED' | 'INVESTIGATING' | 'ESCALATED_AUTHORITIES' | 'RESOLVED';
