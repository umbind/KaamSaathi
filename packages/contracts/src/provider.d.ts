...
export declare const TRUST_BADGE_DEFINITIONS: Record<string, {
    label: string;
    reviewed_item: string;
}>;
export declare const MANDATORY_TRUST_DISCLAIMER = "The platform connects you with independent service providers. The platform does not guarantee provider competence or personal safety. Every badge states exactly what was reviewed.";
